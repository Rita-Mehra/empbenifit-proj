...
const Group = () => {
  ...
  return (
    <SkeletonDiv>
      <div class="content mt4">
        ...
        <div className='table mt4'>
          ...
          <TableRow>
            ...
            <TableCell align="center"># OF EMPLOYEES</TableCell>
          </TableRow>
        </TableHead>
            <TableBody>
              {category.map((row) => (
                <TableRow >
                  <TableCell component="th" rowSpan={row.detail.length + 1} scope="row" className="light-blue-bg w-20">
                    {row.catogery}
                  </TableCell>
                  ...
                  <TableCell>
                    ...
                    {row.detail.map(detail => (
                      <TableRow>
                        <TableCell className="border-btm-0 w-20">{detail.num}</TableCell>
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table" className='w-100 relative'>
        <TableHead>
